...
namespace CounterLib
{
	...
	public class Counter : System.Windows.Forms.UserControl
	{
		...
		private CounterAnimationSpeed animationSpeed = CounterAnimationSpeed.Fast;
		private CounterNumbersTheme numbersTheme = CounterNumbersTheme.n03;
		...
		[DefaultValue(CounterAnimationSpeed.Fast)]
		[Category("Appearance")]
		...
		[DefaultValue(CounterNumbersTheme.n03)]
		[Category("Appearance")]
